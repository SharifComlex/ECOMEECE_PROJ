...
namespace Microflake.Web.Areas.SuperAdmin.Controllers
{
    ...
    public class CustomColorController : BaseController
    {
        private readonly ICustomColorService _entityService;
        private readonly ICustomCategoryService _CategoryService;

        public CustomColorController(ICustomCategoryService CategoryService, ICustomColorService entityService)
        {
