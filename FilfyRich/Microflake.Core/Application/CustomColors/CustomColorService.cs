...
using Microflake.Core.ViewModel.CustomColors;
using System;
...
namespace Microflake.Core.Application.CustomColors
{
    public class CustomColorService : ICustomColorService
    {
        private readonly ApplicationDbContext _context;
        private readonly IResponse _response;
        private readonly ILogger _logger; 
        public CustomColorService(ApplicationDbContext context,
...
;
                ...
                _context.CustomColors.Add(entity);
        ...
        public async Task<ServiceResponse<EditProduct>> Edit(long id)
        {
            try
            {
                var entity = await _context.CustomColors.SingleOrDefaultAsync(x => x.Id == id);
        ...
        public async Task<ServiceResponse<ListProduct>> Update(EditProduct model, string userId)
        {
            try
            {
                var entity = _context.CustomColors.SingleOrDefault(x => x.Id == model.Id);
        ...
        public async Task<ServiceResponse<long>> Delete(long id)
        {
            try
            {
                var entity = _context.CustomColors.Find(id);

                if (entity != null)
                {
                    _context.CustomColors.Remove(entity);
